...
const SavedJobsPage = () => {
  ...
  // Show loading state while checking authentication or fetching jobs
              ...
              <article className="p-6">
                <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                  <div className="flex-grow">
                    ...
                    <p className="text-gray-700 mb-1">{job.company || "Company not specified"}</p>
                    <p className="text-gray-600 mb-4">{job.location || "Location not specified"}</p>
